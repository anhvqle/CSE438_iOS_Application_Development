...
//    func test1Purchase() {
//        XCTAssertEqual(try? purchase(itemNumber: 1, currentStock: 1, inService: false), nil)
//        XCTAssertEqual(try? purchase(itemNumber: -1, currentStock: 1, inService: true), nil)
//        XCTAssertEqual(try? purchase(itemNumber: 1, currentStock: 0, inService: true), nil)
//    }
