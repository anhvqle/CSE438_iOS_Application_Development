...
//: + callout(Let's Create a Data Type): We are building the next big social media app, and we have the concept of "posts". A user can create a "post" and share it with their friends. A "post" consists of a title, message, author name, and the number of likes it has. Create a `Post` object below to help keep track of this data in the app. (Should this be a `class` or a `struct`? There is no real correct answer here, as each has benefits and drawbacks. It is up to you to make an educated choice.)
class Posts {
    var title: String
    var message: String
    var author: String
    ...
    init(title: String, message: String, author: String, numLikes: Int){
        self.title = title
...
var p = Posts(title: "Hello", message: "hi everybody", author: "Anh Le", numLikes: 12345)
print(p.message)
//: ### Other Topics
